/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: 94c7b870dc233e6fe298625774cbec8f)
...
declare namespace Cloudflare {
	interface GlobalProps {
		...
		durableNamespaces: "InstallationLock";
	}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "PUBLIC_URL" | "APNS_TOPIC">> {}
}
declare module "*.cer" {
